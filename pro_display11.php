...
<div class="project-container">
    ...
    <form id="search-filter" action="pro_display.php?pg= <?php echo $pg; ?>" method="post">
    <!-- Search bar -->
            ...
            <tr>
                <th >
                    <a href="<?php if (isset($_GET['sort_name']) && $_GET['sort_name'] == 1) echo 'pro_display.php?sort_name=2';
                                else echo 'pro_display.php?sort_name=1'; ?>"><label><b>NAME<?php if(isset($_GET['sort_name']) && $_GET['sort_name']==2) echo "&#9660;"; else echo "&#9650;";?></b></label></a>
                </th>
                <th>
                    <a href="<?php if (isset($_GET['sort_lang']) && $_GET['sort_lang'] == 1) echo 'pro_display.php?sort_lang=2';
                                else echo 'pro_display.php?sort_lang=1'; ?>"><label><b>LANGUAGE<?php if(isset($_GET['sort_lang']) && $_GET['sort_lang']==2) echo "&#9660;"; else echo "&#9650;";?></b></label>
                </th>
                <?php if($val == 2){?>
                    <th>
                    ACTIONS
        ...
        <nav aria-label="Page navigation example" style="text-align:center;">
            ...
            for ($btn = 1; $btn <= $tot_pages; $btn++) {
                ...
                if ($btn == $pg)
                    ...
                    $ac = "";
                echo "<li class= $ac ><a href='pro_display.php?pg=" . $btn . $pn . $pl . "'>" . $btn . "</a></li>";
            }
